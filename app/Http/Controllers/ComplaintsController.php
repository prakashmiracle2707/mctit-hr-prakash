...
class ComplaintsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $emp_data = [
            ...
            'fromNameEmail' => 'MCT IT SOLUTIONS PVT. LTD Support Team',
            'replyTo'       => 'mctsource@miraclecloud-technology.com',
            'replyToName'   => 'MCT IT SOLUTIONS PVT. LTD Support Team',
        ];
    ...
    public function action($id)
    {
        ...
        $employee = Employee::findOrFail($complaint->employee_id); // Assuming 'User' is the employee model
