    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{ Form::select('branch_id', $branchs, null, ['class' => 'form-control ', 'required' => 'required', 'placeholder' => __('Select Branch')]) }}
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{ Form::select('department_id', $departments, null, ['class' => 'form-control ', 'required' => 'required', 'placeholder' => __('select Department')]) }}
                </div>
            </div>
        </div>
