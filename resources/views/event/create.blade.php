        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="department_div">
                    <select class="form-control department_id" name="department_id[]" placeholder="Select Department" id="choices-multiple" required>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="employee_div">
                    <select class="form-control  employee_id" name="employee_id[]" placeholder="Select Employee" id="choices-multiple1" required>
