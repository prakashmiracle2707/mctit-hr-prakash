    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::select('from_account_id', $accounts, null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Choose Account')]) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('to_account_id', __('To Account'), ['class' => 'col-form-label']) }}<x-required></x-required>
                {{ Form::select('to_account_id', $accounts, null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Choose Account')]) }}
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
