...
{{ Form::model($it_ticket, ['route' => ['it-tickets.update', $it_ticket->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            {{ Form::select('issue_category_id', $categories, $it_ticket->issue_category_id, [
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::select('issue_title_id', $titles, $it_ticket->issue_title_id, [
                'class' => 'form-control select2',
                'required' => 'required',
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::select('priority', ['High' => 'High', 'Medium' => 'Medium', 'Low' => 'Low'], $it_ticket->priority, [
                'class' => 'form-control',
                'required' => true
            ]) }}
        </div>
