...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-12">
            ...
            {!! Form::text('joining_date', null, ['class' => 'form-control d_week', 'required' => 'required','autocomplete'=>'off']) !!}
        </div>

        <div class="form-group col-md-6">
            {!! Form::label('days_of_week', __('Days Of Week'), ['class' => 'col-form-label']) !!}<x-required></x-required>
            {!! Form::text('days_of_week', null, ['class' => 'form-control ', 'required' => 'required','autocomplete'=>'off','placeholder'=>__('Enter Days Of Week')]) !!}
        </div>
        <div class="form-group col-md-6">
            {!! Form::label('salary', __('Salary'), ['class' => 'col-form-label']) !!}<x-required></x-required>
            {!! Form::text('salary', null, ['class' => 'form-control ', 'required' => 'required','autocomplete'=>'off','placeholder'=>__('Enter Salary')]) !!}
        </div>
        <div class="form-group col-md-6">
