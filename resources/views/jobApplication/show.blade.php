                    ...
                    <div class="d-flex align-items-center" data-toggle="tooltip" data-placement="right"
                        ...
                        <a href="{{ !empty($jobApplication->profile) ?($profiles . $jobApplication->profile) : $logo."avatar.png" }}" target="_blank" class="avatar rounded-circle avatar-sm">
                            <img src="{{ !empty($jobApplication->profile) ? ($profiles . $jobApplication->profile) : $logo."avatar.png" }}"
                                class="img-fluid rounded border-2 border border-primary" width="55px" style="height: 55px">
                        </a>
                        </div>
                 ...
                 <dl class="row">
                    ...
                    <dd class="col-sm-8">
                        ...
                        <div class="dt-buttons">
                            <span class="text-sm action-btn bg-primary me-2">
                                <a href="{{ $resumes . '/' . $jobApplication->resume }}"
                                    data-bs-toggle="tooltip" data-bs-original-title="{{ __('download') }}"
                                    download=""><span class="text-white"><i class="ti ti-download "></i></span></a>
                            </span>
                            <div class="action-btn bg-secondary ">
                                <a class="mx-3 btn btn-sm align-items-center" href="{{$resumes . '/' . $jobApplication->resume }}" target="_blank"  >
                                    <span class="text-white"><i class="ti ti-crosshair " data-bs-toggle="tooltip" data-bs-original-title="{{ __('Preview') }}"></i></span>
                                </a>
                            </div>
                        @else
                            -
        ...
        <div class="card card-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col text-end">
                        @can('Create Interview Schedule')
                            <a  data-url="{{ route('interview-schedules.create', $jobApplication->id) }}"
            ...
            <div class="card-body">
                ...
                @can('Add Job Application Skill')
                    <div class="form-group">
                        <input type="submit" value="{{ __('Add Skills') }}" required class="btn-sm btn btn-primary">
                    </div>
                @endcan
                {{ Form::close() }}
                ...
                <div class="form-group">
                    ...
                    <textarea name="note" class="form-control" id="" required rows="3"></textarea>
                </div>
