                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="choose-files ">
                                            <label for="profile">
                                                ...
                                                <img id="blah" class="img-fluid rounded border-2 border border-primary" width="120px" style="height: 120px" width="100" style="border-radius: 50%" src="{{ !empty($userDetail->avatar) ? $profile . $userDetail->avatar : $profile . '/avatar.png' }}" />
                                            </label>
                                        </div>
                                        <span
